package in.rombashop.romba.ui.collection.productCollectionHeader;
...
import in.rombashop.romba.databinding.FragmentProductCollectionHeaderListBinding;
import in.rombashop.romba.ui.collection.adapter.ProductCollectionHeaderListAdapter;
...
public class ProductCollectionHeaderListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
                    ...
                    if (lastPosition == adapter.get().getItemCount() - 1) {
                        ...
                        if (!binding.get().getLoadingMore() && !productCollectionViewModel.forceEndLoading) {
                            ...
                            if (connectivity.isConnected()) {
                                ...
                                productCollectionViewModel.setNextPageLoadingStateObj( String.valueOf(Config.PRODUCT_COUNT), String.valueOf(productCollectionViewModel.offset));
                            }
                        }
                    }
                }
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            productCollectionViewModel.setProductCollectionHeaderListObj( String.valueOf(Config.PRODUCT_COUNT), String.valueOf(productCollectionViewModel.offset));
