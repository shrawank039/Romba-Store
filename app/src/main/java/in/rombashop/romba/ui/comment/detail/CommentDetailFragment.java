...
import in.rombashop.romba.databinding.FragmentCommentDetailBinding;
import in.rombashop.romba.ui.comment.detail.adapter.CommentDetailAdapter;
...
public class CommentDetailFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().sendImageButton.setOnClickListener(view -> {
            if (!commentDetailListViewModel.isLoading) {
                ...
                Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, CommentDetailFragment.this.getActivity(), navigationController, new Utils.NavigateOnUserVerificationActivityCallback() {
                    @Override
    ...
    private void replaceData(List<CommentDetail> commentList) {
