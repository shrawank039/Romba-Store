package in.rombashop.romba.ui.checkout.adapter;
...
import in.rombashop.romba.databinding.ItemChekoutBasketAdapterBinding;
...
public class CheckoutBasketAdapter extends DataBoundListAdapter<Basket, ItemChekoutBasketAdapterBinding> {
...
//    private int minOrder = 0;
    ...
    public CheckoutBasketAdapter(androidx.databinding.DataBindingComponent dataBindingComponent, BasketClickCallBack basketClickCallBack, DiffUtilDispatchedInterface diffUtilDispatchedInterface) {
    ...
    @Override
    protected ItemChekoutBasketAdapterBinding createBinding(ViewGroup parent) {
        ItemChekoutBasketAdapterBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()),
                        R.layout.item_chekout_basket_adapter, parent, false,
    ...
    @Override
    protected void bind(ItemChekoutBasketAdapterBinding binding, Basket item) {
        ...
        if (replaceString.equals("")) {
            ...
            binding.attributeTextView.setText(String.format(Locale.US, "(%s)", replaceString));
        }
