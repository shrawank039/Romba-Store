...
import in.rombashop.romba.databinding.FragmentNotificationListBinding;
import in.rombashop.romba.ui.common.DataBoundListAdapter;
import in.rombashop.romba.ui.common.PSFragment;
import in.rombashop.romba.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initViewModels() {
        notificationListViewModel = ViewModelProviders.of(this, viewModelFactory).get(NotificationsViewModel.class);
    }
    ...
    private void replaceData(List<Noti> notificationList) {
