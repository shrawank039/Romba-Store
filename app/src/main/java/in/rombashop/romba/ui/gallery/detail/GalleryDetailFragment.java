...
import in.rombashop.romba.databinding.FragmentGalleryDetailBinding;
...
import in.rombashop.romba.utils.TouchImageView;
...
//        }
    ...
    protected void initData() {
        ...
        try {
            ...
            if (getActivity() != null) {
                imageViewModel.id = getActivity().getIntent().getStringExtra(Constants.PRODUCT_ID);
            }
