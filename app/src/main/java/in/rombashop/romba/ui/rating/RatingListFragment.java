package in.rombashop.romba.ui.rating;
...
import in.rombashop.romba.databinding.FragmentRatingListBinding;
import in.rombashop.romba.databinding.ItemRatingEntryBinding;
import in.rombashop.romba.ui.common.DataBoundListAdapter;
import in.rombashop.romba.ui.common.PSFragment;
import in.rombashop.romba.ui.rating.adapter.RatingListAdapter;
...
public class RatingListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.edit_rating) {
            ...
            Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, RatingListFragment.this.getActivity(), navigationController, new Utils.NavigateOnUserVerificationActivityCallback() {
                @Override
    ...
    protected void initUIAndActions() {
        ...
        binding.get().writeReviewButton.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                if (layoutManager != null) {
                    ...
                    if (lastPosition == adapter.get().getItemCount() - 1) {
                        ...
                        if (!ratingViewModel.forceEndLoading) {
                            ...
                            ratingViewModel.setNextPageLoadingStateObj(ratingViewModel.productId, String.valueOf(Config.RATING_COUNT), Constants.ZERO);
