...
import in.rombashop.romba.databinding.FragmentSearchBinding;
...
public class SearchFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().categorySelectionView.setOnClickListener(view -> navigationController.navigateToSearchActivityCategoryFragment(SearchFragment.this.getActivity(), Constants.CATEGORY, catId, subCatId, Constants.NO_DATA, Constants.NO_DATA));
        ...
        binding.get().subCategorySelectionView.setOnClickListener(view -> {
            ...
            if (catId.equals(Constants.NO_DATA)) {
                ...
                navigationController.navigateToSearchActivityCategoryFragment(SearchFragment.this.getActivity(), Constants.SUBCATEGORY, catId, subCatId, Constants.NO_DATA, Constants.NO_DATA);
            }
        });
...
//            homeSearchProductViewModel.holder.overall_rating = "";
    ...
    private void selectStar(Button star) {
        ...
        star.setBackgroundColor(getResources().getColor(R.color.global__primary));
