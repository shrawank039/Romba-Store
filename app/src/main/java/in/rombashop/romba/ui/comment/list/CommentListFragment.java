package in.rombashop.romba.ui.comment.list;
...
import in.rombashop.romba.databinding.FragmentCommentListBinding;
import in.rombashop.romba.ui.comment.list.adapter.CommentListAdapter;
...
public class CommentListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void loadData() {
        ...
        LiveData<Resource<List<Comment>>> news = commentListViewModel.getCommentListData();
    ...
    private void replaceData(List<Comment> commentList) {
