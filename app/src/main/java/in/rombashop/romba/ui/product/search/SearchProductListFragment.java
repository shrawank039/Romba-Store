...
public class SearchProductListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
...
//        homeSearchProductViewModel.holder.shopId = selectedShopId;
        ...
        if (getActivity() != null) {
            ...
            if(getArguments() != null){
                homeSearchProductViewModel.holder = (ProductParameterHolder) getArguments().getSerializable(Constants.PRODUCT_PARAM_HOLDER_KEY);
            }
        ...
        touchCountViewModel.getTouchCountPostData().observe(this, result -> {
            if (result != null) {
                if (result.status == Status.SUCCESS) {
                    if (SearchProductListFragment.this.getActivity() != null) {
    ...
    private void ButtonClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.typeButton:
                ...
                navigationController.navigateToTypeFilterFragment(SearchProductListFragment.this.getActivity(), homeSearchProductViewModel.holder.catId,
