package in.rombashop.romba.ui.shop;
...
import in.rombashop.romba.databinding.FragmentShopProfileBinding;
    ...
    protected void initUIAndActions() {
        ...
        binding.get().phone1TextView.setOnClickListener(view -> {
            ...
            if (!(number1.trim().isEmpty() || number1.trim().equals("-"))) {
                Utils.callPhone(ShopProfileFragment.this, number1);
            }
        ...
        binding.get().phone2TextView.setOnClickListener(view -> {
            ...
            if (!(number2.trim().isEmpty() || number2.trim().equals("-"))) {
                Utils.callPhone(ShopProfileFragment.this, number2);
            }
        });
