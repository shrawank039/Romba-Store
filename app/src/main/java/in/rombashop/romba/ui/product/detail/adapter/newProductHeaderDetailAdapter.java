...
public class newProductHeaderDetailAdapter extends ArrayAdapter<ProductAttributeDetail> {
    private final List<ProductAttributeDetail> items;
    private final androidx.databinding.DataBindingComponent dataBindingComponent;

    newProductHeaderDetailAdapter(@NonNull Context context, @LayoutRes int resource,
