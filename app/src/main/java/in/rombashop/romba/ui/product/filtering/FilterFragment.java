...
import in.rombashop.romba.databinding.FragmentFilterBinding;
...
//            homeSearchProductViewModel.holder.overall_rating = "";
        ...
        binding.get().oneStar.setOnClickListener(v -> {
            ...
            if (homeSearchProductViewModel.holder.rating_value_one.equals("")) {
                FilterFragment.this.selectStar(Constants.RATING_ONE);
                FilterFragment.this.unSelectStar(Constants.RATING_TWO);
                FilterFragment.this.unSelectStar(Constants.RATING_THREE);
                FilterFragment.this.unSelectStar(Constants.RATING_FOUR);
                FilterFragment.this.unSelectStar(Constants.RATING_FIVE);
            } else {
                FilterFragment.this.unSelectStar(Constants.RATING_ONE);
            }
