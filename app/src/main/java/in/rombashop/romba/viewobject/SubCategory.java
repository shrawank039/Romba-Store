...
public class SubCategory {
    ...
    public SubCategory(@NonNull String id, String catId, String name, String status, String ordering, String addedDate, String addedUserId, String updatedDate, String updatedUserId, String updatedFlag, String addedDateStr, Image defaultPhoto, Image defaultIcon) {
        this.id = id;
        this.catId = catId;
        this.name = name;
        this.status = status;
