...
public class Category {
    ...
    public Category(@NonNull String id,String name, String status, String addedDate, String addedUserId, String updatedDate, String updatedUserId, String updatedFlag, String addedDateStr, String touchCount, Image defaultPhoto, Image defaultIcon) {
        this.id = id;
        this.name = name;
        this.status = status;
