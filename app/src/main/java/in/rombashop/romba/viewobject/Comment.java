...
public class Comment {
    ...
    public Comment(@NonNull String id, String productId, String userId, String headerComment, String status, String addedDate, String updatedDate, String commentReplyCount, String addedDateStr, User user) {
        this.id = id;
