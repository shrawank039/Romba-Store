...
public class ShippingMethod{
    ...
    public ShippingMethod(@NonNull String id,float price, String name, String days, String addedDate, String updatedDate, String addedUserId, String updatedUserId, String updatedFlag, String isPublished, String addedDateStr, String currencyShortForm, String currencySymbol) {
        this.id = id;
        this.price = price;
        this.name = name;
        this.days = days;
