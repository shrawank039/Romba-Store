...
public class ProductCollectionHeader {
    ...
    public ProductCollectionHeader(@NonNull String id, String name, String status, String addedDate, String addedUserId, String updatedDate, String updatedUserId, String updatedFlag, String addedDateStr, Image defaultPhoto) {
        this.id = id;
        this.name = name;
        this.status = status;
