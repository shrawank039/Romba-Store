package in.rombashop.romba.viewmodel.comment;

import in.rombashop.romba.Config;
import in.rombashop.romba.repository.comment.CommentDetailRepository;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
