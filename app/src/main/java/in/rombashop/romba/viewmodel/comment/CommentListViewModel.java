...
import in.rombashop.romba.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
