...
public interface PSApiService {
    ...
    LiveData<ApiResponse<List<Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("product_id") String productId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    LiveData<ApiResponse<List<CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    Call<ApiStatus> rawRegisterNotiToken(@Path("API_KEY") String apiKey, @Field("platform_name") String platform,
                                         @Field("device_id") String deviceId, @Field("user_id") String userId);


    @FormUrlEncoded
    @POST("rest/notis/unregister/api_key/{API_KEY}")
    Call<ApiStatus> rawUnregisterNotiToken(@Path("API_KEY") String apiKey, @Field("platform_name") String platform,
                                           @Field("device_id") String deviceId,@Field("user_id") String userId);
