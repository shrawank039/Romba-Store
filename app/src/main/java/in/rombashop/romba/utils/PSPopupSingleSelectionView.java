...
public class PSPopupSingleSelectionView extends LinearLayout {
    ...
    public PSPopupSingleSelectionView(Context context, String title, List<Category> categories) {
        super(context, null);
        Utils.psLog("2***");
        this.title = title;
    ...
    public void setDataArrayList(List<Category> objArrayList) {
        int i = 0;
